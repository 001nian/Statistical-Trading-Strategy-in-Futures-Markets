...
% For CO %%%%%%%%%%%%%%%
%dataFile='CO-5min.csv';
%%%%%%%%%%%%%%%%%%%%%%%%

% For COKE %%%%%%%%%%%%%%%
%dataFile='COKE-5min.csv';
%%%%%%%%%%%%%%%%%%%%%%%%%%
...
outSample=[datenum('06/14/2011'),datenum('04/14/2014')];
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

% For CO %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%inSample=[datenum('08/01/2003'),datenum('08/01/2013')];
%outSample=[datenum('08/02/2013'),datenum('04/06/2023')];
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

% For COKE %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%inSample=[datenum('05/03/2018'),datenum('05/03/2020')];
%outSample=[datenum('05/04/2020'),datenum('04/06/2022')];
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
Length=10000:100:11000;
StopPct=0.000:0.002:0.020;
